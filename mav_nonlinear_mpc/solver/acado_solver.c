...
state[120] = acadoVariables.od[lRun1 * 12];
state[121] = acadoVariables.od[lRun1 * 12 + 1];
state[122] = acadoVariables.od[lRun1 * 12 + 2];
state[123] = acadoVariables.od[lRun1 * 12 + 3];
state[124] = acadoVariables.od[lRun1 * 12 + 4];
state[125] = acadoVariables.od[lRun1 * 12 + 5];
state[126] = acadoVariables.od[lRun1 * 12 + 6];
state[127] = acadoVariables.od[lRun1 * 12 + 7];
state[128] = acadoVariables.od[lRun1 * 12 + 8];
state[129] = acadoVariables.od[lRun1 * 12 + 9];
state[130] = acadoVariables.od[lRun1 * 12 + 10];
state[131] = acadoVariables.od[lRun1 * 12 + 11];
...
a[10] = (od[9]-xd[6]);
a[11] = (a[9]*a[10]);
a[12] = ((real_t)(1.0000000000000000e+00)/(real_t)(5.0000000000000000e-01));
a[13] = ((a[8]+a[11])*a[12]);
...
a[18] = (od[10]-xd[7]);
a[19] = (a[17]*a[18]);
a[20] = ((real_t)(1.0000000000000000e+00)/(real_t)(5.0000000000000000e-01));
a[21] = ((a[16]+a[19])*a[20]);
...
a[26] = (od[11]-xd[8]);
a[27] = (a[25]*a[26]);
a[28] = ((real_t)(1.0000000000000000e+00)/(real_t)(1.0000000000000000e+00));
a[29] = ((a[24]+a[27])*a[28]);
...
/* Compute outputs: */
out[0] = ((((((od[9]-xd[6])*(od[9]-xd[6]))/(real_t)(5.0000000000000000e-01))+(((od[10]-xd[7])*(od[10]-xd[7]))/(real_t)(5.0000000000000000e-01)))+(((od[11]-xd[8])*(od[11]-xd[8]))/(real_t)(1.0000000000000000e+00)))+u[3]);
out[1] = a[0];
out[2] = a[1];
out[3] = a[2];
out[4] = a[3];
...
acadoWorkspace.objValueIn[12] = acadoVariables.od[runObj * 12];
acadoWorkspace.objValueIn[13] = acadoVariables.od[runObj * 12 + 1];
acadoWorkspace.objValueIn[14] = acadoVariables.od[runObj * 12 + 2];
acadoWorkspace.objValueIn[15] = acadoVariables.od[runObj * 12 + 3];
acadoWorkspace.objValueIn[16] = acadoVariables.od[runObj * 12 + 4];
acadoWorkspace.objValueIn[17] = acadoVariables.od[runObj * 12 + 5];
acadoWorkspace.objValueIn[18] = acadoVariables.od[runObj * 12 + 6];
acadoWorkspace.objValueIn[19] = acadoVariables.od[runObj * 12 + 7];
acadoWorkspace.objValueIn[20] = acadoVariables.od[runObj * 12 + 8];
acadoWorkspace.objValueIn[21] = acadoVariables.od[runObj * 12 + 9];
acadoWorkspace.objValueIn[22] = acadoVariables.od[runObj * 12 + 10];
acadoWorkspace.objValueIn[23] = acadoVariables.od[runObj * 12 + 11];
...
acadoWorkspace.objValueIn[9] = acadoVariables.od[240];
acadoWorkspace.objValueIn[10] = acadoVariables.od[241];
acadoWorkspace.objValueIn[11] = acadoVariables.od[242];
acadoWorkspace.objValueIn[12] = acadoVariables.od[243];
acadoWorkspace.objValueIn[13] = acadoVariables.od[244];
acadoWorkspace.objValueIn[14] = acadoVariables.od[245];
acadoWorkspace.objValueIn[15] = acadoVariables.od[246];
acadoWorkspace.objValueIn[16] = acadoVariables.od[247];
acadoWorkspace.objValueIn[17] = acadoVariables.od[248];
acadoWorkspace.objValueIn[18] = acadoVariables.od[249];
acadoWorkspace.objValueIn[19] = acadoVariables.od[250];
acadoWorkspace.objValueIn[20] = acadoVariables.od[251];
...
acadoWorkspace.conValueIn[12] = acadoVariables.od[lRun1 * 12];
acadoWorkspace.conValueIn[13] = acadoVariables.od[lRun1 * 12 + 1];
acadoWorkspace.conValueIn[14] = acadoVariables.od[lRun1 * 12 + 2];
acadoWorkspace.conValueIn[15] = acadoVariables.od[lRun1 * 12 + 3];
acadoWorkspace.conValueIn[16] = acadoVariables.od[lRun1 * 12 + 4];
acadoWorkspace.conValueIn[17] = acadoVariables.od[lRun1 * 12 + 5];
acadoWorkspace.conValueIn[18] = acadoVariables.od[lRun1 * 12 + 6];
acadoWorkspace.conValueIn[19] = acadoVariables.od[lRun1 * 12 + 7];
acadoWorkspace.conValueIn[20] = acadoVariables.od[lRun1 * 12 + 8];
acadoWorkspace.conValueIn[21] = acadoVariables.od[lRun1 * 12 + 9];
acadoWorkspace.conValueIn[22] = acadoVariables.od[lRun1 * 12 + 10];
acadoWorkspace.conValueIn[23] = acadoVariables.od[lRun1 * 12 + 11];
...
acadoVariables.lbAValues[0] = 5.0000000000000000e-01;
...
acadoVariables.lbAValues[12] = 5.0000000000000000e-01;
...
state[120] = acadoVariables.od[index * 12];
state[121] = acadoVariables.od[index * 12 + 1];
state[122] = acadoVariables.od[index * 12 + 2];
state[123] = acadoVariables.od[index * 12 + 3];
state[124] = acadoVariables.od[index * 12 + 4];
state[125] = acadoVariables.od[index * 12 + 5];
state[126] = acadoVariables.od[index * 12 + 6];
state[127] = acadoVariables.od[index * 12 + 7];
state[128] = acadoVariables.od[index * 12 + 8];
state[129] = acadoVariables.od[index * 12 + 9];
state[130] = acadoVariables.od[index * 12 + 10];
state[131] = acadoVariables.od[index * 12 + 11];
...
state[120] = acadoVariables.od[240];
state[121] = acadoVariables.od[241];
state[122] = acadoVariables.od[242];
state[123] = acadoVariables.od[243];
state[124] = acadoVariables.od[244];
state[125] = acadoVariables.od[245];
state[126] = acadoVariables.od[246];
state[127] = acadoVariables.od[247];
state[128] = acadoVariables.od[248];
state[129] = acadoVariables.od[249];
state[130] = acadoVariables.od[250];
state[131] = acadoVariables.od[251];
...
acadoWorkspace.objValueIn[12] = acadoVariables.od[lRun1 * 12];
acadoWorkspace.objValueIn[13] = acadoVariables.od[lRun1 * 12 + 1];
acadoWorkspace.objValueIn[14] = acadoVariables.od[lRun1 * 12 + 2];
acadoWorkspace.objValueIn[15] = acadoVariables.od[lRun1 * 12 + 3];
acadoWorkspace.objValueIn[16] = acadoVariables.od[lRun1 * 12 + 4];
acadoWorkspace.objValueIn[17] = acadoVariables.od[lRun1 * 12 + 5];
acadoWorkspace.objValueIn[18] = acadoVariables.od[lRun1 * 12 + 6];
acadoWorkspace.objValueIn[19] = acadoVariables.od[lRun1 * 12 + 7];
acadoWorkspace.objValueIn[20] = acadoVariables.od[lRun1 * 12 + 8];
acadoWorkspace.objValueIn[21] = acadoVariables.od[lRun1 * 12 + 9];
acadoWorkspace.objValueIn[22] = acadoVariables.od[lRun1 * 12 + 10];
acadoWorkspace.objValueIn[23] = acadoVariables.od[lRun1 * 12 + 11];
